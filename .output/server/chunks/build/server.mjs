import { hasInjectionContext, inject, version, ref, watchEffect, watch, getCurrentInstance, toRef, isRef, defineComponent, createElementBlock, h, computed, unref, provide, shallowReactive, Suspense, nextTick, Fragment, Transition, useSSRContext, mergeProps, withCtx, renderSlot, createVNode, createTextVNode, toDisplayString, isVNode, resolveDynamicComponent, openBlock, createBlock, createCommentVNode, renderList, createApp, effectScope, reactive, getCurrentScope, onErrorCaptured, onServerPrefetch, defineAsyncComponent, shallowRef, isReadonly, isShallow, isReactive, toRaw } from 'vue';
...
import { ssrRenderComponent, ssrRenderSlot, ssrRenderList, ssrInterpolate, ssrRenderVNode, ssrRenderAttrs, ssrRenderSuspense } from 'vue/server-renderer';
...
const _routes = [
  ...
  },
  {
    ...
    component: () => import('./bulk-BsEnTs2e.mjs')
  },
  {
    name: "admin",
    path: "/admin",
    meta: __nuxt_page_meta$5 || {},
    component: () => import('./index-DKcLW6le.mjs')
  },
  {
  ...
  },
  {
    ...
    component: () => import('./login-8zukbZwl.mjs')
  },
  {
    name: "index",
    path: "/",
    meta: __nuxt_page_meta || {},
    component: () => import('./index-Bomm3zfj.mjs')
  }
];
...
const namedMiddleware = {
  "is-admin": () => import('./is.admin-D--VcqU6.mjs'),
  "is-auth": () => import('./is.auth-D9YODouk.mjs')
};
...
const layouts = {
  admin: () => import('./admin-BmBjkS2U.mjs'),
  auth: () => import('./auth-Dxmw1tpL.mjs'),
  user: () => import('./user-spF7j2-G.mjs')
};
                    ...
                    return [
                      createVNode("div", { class: "grid gap-1" }, [
                        ...
                        toast2.description ? (openBlock(), createBlock(Fragment, { key: 1 }, [
                          isVNode(toast2.description) ? (openBlock(), createBlock(unref(_sfc_main$7), { key: 0 }, {
                            default: withCtx(() => [
                              (openBlock(), createBlock(resolveDynamicComponent(toast2.description)))
                            ]),
                            _: 2
                          }, 1024)) : (openBlock(), createBlock(unref(_sfc_main$7), { key: 1 }, {
                            default: withCtx(() => [
                              createTextVNode(toDisplayString(toast2.description), 1)
                            ]),
                            _: 2
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-C8VDCgSq.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-C1pjgNue.mjs'));
...
export { useRoute as a, useToast as b, cn as c, defineNuxtRouteMiddleware as d, entry$1 as default, useRouter as e, nuxtLinkDefaults as f, useNuxtApp as g, useRuntimeConfig as h, useState as i, navigateTo as n, resolveRouteObject as r, toast as t, useHead as u };
